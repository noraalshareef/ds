...
public class KeystoreGenerator {
    ...
    private static final String DEFAULT_KEYSTORE_PASSWORD = "nora-password";
    ...
    public static void main(String[] args) {
        try {
            KeystoreGenerator.aGenerator()
                    .withCertificateDirectory(DEFAULT_KEYSTORE_CERTIFICATES_FILEPATH)
                    .withKeyStoreFilepath(DEFAULT_KEYSTORE_FILEPATH)
                    .generateKeystore();
