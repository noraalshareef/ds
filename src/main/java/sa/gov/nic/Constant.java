...
public final class Constant
{
    ...
    public static final long CACHE_ALL_DATA_FILES = -1L;
    public static final long CACHE_NO_DATA_FILES = 0L;
    @Deprecated
    ...
    public static class Production
    {
        ...
        static {
            DEFAULT_TRUESTED_TERRITORIES = Arrays.asList("AT", "BE", "BG", "CY", "CZ", "DK", "EE", "ES", "FI", "FR", "GR", "HU", "IE", "IS", "IT", "LT", "LU", "LV", "LI", "MT", "NO", "NL", "PL", "PT", "RO", "SE", "SI", "SK", "UK");
        }
    }
