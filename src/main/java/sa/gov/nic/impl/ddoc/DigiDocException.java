...
public class DigiDocException extends Exception {
    ...
    public boolean isBadSignature() {
        return this.m_code == 81 || this.m_code == 70 || this.m_code == 79 || this.m_code == 82 || this.m_code == 84 || this.m_code == 78 || this.m_code == 80 || this.m_code == 53 || this.m_code == 83 || this.m_code == 72 || this.m_code == 71 || this.m_code == 94;
    }
    ...
    public String toString() {
        ...
        sb.append((new Integer(this.m_code)).toString());
    ...
    public String getMessage() {
        return this.m_detail == null ? super.getMessage() : this.m_code + super.getMessage() + "; nested exception is: \n\t" + this.m_detail.toString();
    }
    ...
    public void printStackTrace(PrintStream ps) {
        if (this.m_detail == null) {
            ...
            synchronized(ps) {
                ps.println(this);
                this.m_detail.printStackTrace(ps);
            }
        }
    ...
    public void printStackTrace(PrintWriter pw) {
        if (this.m_detail == null) {
            ...
            synchronized(pw) {
                pw.println(this);
                this.m_detail.printStackTrace(pw);
            }
        }
